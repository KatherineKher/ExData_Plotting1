...
plot(dataDays, filteredData$Global_active_power, type = "l",xlab = "", ylab = "Global Active Power")

plot(dataDays, filteredData$Voltage,type = "l",xlab = "datetime", ylab = "Voltage" )
...
plot(dataDays, filteredData$Global_active_power,type = "l",xlab = "datetime" ,ylab = "global_active_power")
